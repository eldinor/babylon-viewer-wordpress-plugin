...
function babylonviewerv2_call() {
   if ( strpos( get_the_content(), '[babylonviewer]' ) !== false || strpos( get_the_content(), '</babylon-viewer>' ) !== false ) {
    wp_enqueue_script_module( 'babylon-viewer', esc_url_raw( 'https://cdn.jsdelivr.net/npm/@babylonjs/viewer@7.35.1-alpha/dist/babylon-viewer.esm.min.js' ), array(), null, true );
   }
